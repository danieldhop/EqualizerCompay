...
public class ForegroundService extends Service{
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (intent.getAction().equals(Constants.ACTION.STARTFOREGROUND_ACTION)) {
            Log.i(LOG_TAG, "Intenção de Plano de Parada Recebida ");
            ...
            Notification notification = new NotificationCompat.Builder(this,CHANNEL_ID).setSmallIcon(R.drawable.eq_icon)
                    .setContentTitle("Equalizador Sônicor")
                    .setContentText("Equalizador está ativado")
    ...
    private void createNotificationChannel() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            CharSequence name = "Equalizador Sônicor";
            String description = "Equalizador está ativado";
